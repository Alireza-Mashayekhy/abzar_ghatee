        ...
        <div class="bg-gray-50">
            ...
            >
                <div class="container rounded-lg bg-white p-5 dark:bg-zinc-900">
                    ...
                    <!-- Content -->
                    <p
                        class="mb-5 leading-loose text-zinc-600 dark:text-zinc-300"
                    >
                    ...
                    <div class="grid grid-cols-5 gap-6">
                        ...
                        <div
                            class="order-first col-span-5 md:order-last md:col-span-2"
                        >
                            <ul class="space-y-6">
                                <li>
                                    <!-- Email -->
                                ...
                                <li>
                                    ...
                                    <div class="flex flex-col gap-y-4">
                                        <p
                                            class="min-w-fit text-zinc-600 dark:text-zinc-300"
                                        >
                                            آدرس دفتر مرکزی
                                        </p>
                                        <a
                                            ...
                                            class="text-emerald-500 dark:text-emerald-400"
                                        >
                                            استان اصفهان شهر اصفهان - خیابان
                                            اشرفی اصفهانی (کهندژ) - کوچه 5.1 -
                                            پلاک 4
                                        </a>
                                    </div>
                                </li>
