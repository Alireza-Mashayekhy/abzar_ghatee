            ...
            >
                <div class="container rounded-lg bg-white p-5 dark:bg-zinc-900">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            پس از ۱۰ سال خرید و فروش ابزار و قطعات یدکی در
                            اصفهان تصمیم به ایجاد بستری برای توزیع ابزار و قطعات
                            در سطح کشور گرفتیم. بستری که مشتریان از سرتاسر ایران
                            بتوانند به راحتی در آن سفارش خود را ثبت نموده و
                            ابزار و قطعات یدکی مورد خود را خریداری کنند. فروشگاه
                            اینترنتی ابزار قطعه به منظور فراهم کردن محیطی برای
                            سفارش آسان و سریع ابزار برقی و قطعات یدکی ابزار برقی
                            ساخته شده است. در این فروشگاه می توانید انواع ابزار
                            برقی و قطعات آنها را با قیمت های واقعی مشاهده و به
                            راحتی خریداری نمایید و در مدت زمان کوتاهی درب منزل
                            تحویل بگیرید. کیفیت محصولات و قطعات یدکی ارسالی و هم
                            چنین شفافیت در نوع محصولات همواره مورد توجه
                            ابزارقطعه بوده است. از این رو برای تمامی محصولات
                            شرکتی اسم شرکت و برند در ویژگی ها و نام محصول ثبت
                            شده است تا مشتریان بتوانند با خیال راحت آن محصول را
                            خریداری کنند. هم چنین برای تمامی محصولات گارانتی
                            سلامت و اصالت ثبت می باشد. یکی دیگر از تعهد های
                            فروشگاه ابزار قطعه رساندن قطعات ابزار برقی با قیمت
                            واقعی به دست مشتریان می باشد تا با خیال راحت محصول
                            مورد نظر را خریداری کنند.
                        </p>
                        <ul
                            class="mb-5 list-inside list-decimal space-y-3 text-zinc-600 dark:text-zinc-300"
                        >
                            <li>
                                <strong class="mb-2"
                                    >نمایندگی معتبر از برترین تولید کنندگان و
                                    وارد کنندگان</strong
                                >
                                <p>
                                    با داشتن نمایندگی از اکثر برندهای برتر در
                                    زمینه‌ی ابزارهای برقی و قطعات یدکی آنها، ما
                                    اطمینان می‌دهیم که محصولات بصورت دست اول و
                                    با بهترین قیمت و کیفیت در اختیار شما قرار می
                                    گیرند.
                                </p>
                            </li>
                            <li>
                                <strong class="mb-2"
                                    >قیمت مناسب و راحتی در سفارش</strong
                                >
                                <p>
                                    با توجه به روابط مستقیم با تولید کنندگان و
                                    وارد کنندگان، ما می‌توانیم محصولات با قیمتی
                                    رقابتی و منصفانه را به شما ارائه دهیم.
                                    همچنین، با سیستم سفارش راحت و سریع محصولات
                                    از طریق وبسایت ما، خرید خود را به سادگی و
                                    سرعت بیشتری انجام دهید.
                                </p>
                            </li>
                            <li>
                                <strong class="mb-2"
                                    >تنوع بالا و توانایی تأمین قطعات هر
                                    نیاز</strong
                                >
                                <p>
                                    از ابزارهای برقی گرفته تا قطعات یدکی، ما
                                    تنوعی بی‌نظیر از محصولات را در اختیار شما
                                    قرار می‌دهیم. بدون نگرانی از نیازهای خود، به
                                    ما اعتماد کنید تا به شما کمک کنیم تا قطعات
                                    مورد نیاز خود پیدا کنید.
                                </p>
                            </li>
                            <li>
                                <strong class="mb-2"
                                    >داشتن قیمت های همکاری</strong
                                >
                                <p>
                                    اگر مایل به خرید عمده و یا همکاری هستید، پس
                                    از ثبت نام با تماس با بخش پشتیبانی سطح
                                    کاربری شما تغییر می کند و می توانید محصولات
                                    را با قیمت ویژه خریداری کنید.
                                </p>
                            </li>
                            <li>
                                <strong class="mb-2">قطعات با کیفیت</strong>
                                <p>
                                    در ابزارقطعه کیفیت قطعات بصورت صادقانه مشخص
                                    شده اند و شما می توانید به راحتی قطعات با
                                    کیفیت مورد نیاز را خریداری کنید.
                                </p>
                            </li>
                        </ul>
                    </div>
