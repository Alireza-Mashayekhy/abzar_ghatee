            ...
            <div class="container">
                ...
                >
                    ...
                    >
                        <div>
                            <svg
                                class="h-20 w-20 text-emerald-500 dark:text-emerald-400"
                            >
                                <use xlink:href="#check" />
                            </svg>
                        </div>
                        <h1
                            class="mb-8 text-center text-base text-emerald-500 dark:text-emerald-400 md:text-lg lg:text-xl"
                        >
                            پرداخت شما موفق بود!
                        </h1>
                    </div>
                    ...
                    <div class="flex gap-x-4">
                        ...
                        <div v-else class="w-full">
                            <NuxtLink href="" class="btn-primary py-3">
                                مشاهده ی کیف پول
                            </NuxtLink>
                        </div>
                        <div class="w-full">
