    ...
    <div>
        ...
        <div v-show="invoice_detail.want_official_bill" class="box shadow-md p-5 my-5 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-5">
            <div class="col-span-2">
                ...
                <select id="customer_type" v-model="invoice_detail.customer_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            ...
            <div v-show="invoice_detail.customer_type==='person'" class="col-span-2">
                ...
                <input type="text" id="name" v-model="invoice_detail.name" placeholder="نام  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>

            <div v-show="invoice_detail.customer_type==='person'" class="col-span-2">
                <label for="national_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">کد ملی</label>
                <input type="text" id="national_code" v-model="invoice_detail.national_code" placeholder="کد ملی  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>
            ...
            <div v-show="invoice_detail.customer_type==='company'" class="col-span-2">
                ...
                <input type="text" id="company" v-model="invoice_detail.company" placeholder="نام شرکت  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>

            <div v-show="invoice_detail.customer_type==='company'" class="col-span-2">
                <label for="economic_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">کد اقتصادی</label>
                <input type="text" id="economic_code" v-model="invoice_detail.economic_code" placeholder="کد اقتصادی  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>

            <div v-show="invoice_detail.customer_type==='company'" class="col-span-2">
                <label for="national_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">شناسه ملی</label>
                <input type="text" id="national_id" v-model="invoice_detail.national_id" placeholder="شناسه ملی  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>

            <div v-show="invoice_detail.customer_type==='company'" class="col-span-2">
                <label for="registration_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">شماره ثبت</label>
                <input type="text" id="registration_number" v-model="invoice_detail.registration_number" placeholder="شماره ثبت  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>
            ...
            <div v-show="invoice_detail.customer_type==='person' || invoice_detail.customer_type==='company'" class="col-span-2">
                ...
                <input type="text" id="phone" v-model="invoice_detail.phone" placeholder="شماره تلفن ثابت را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>

            <div v-show="invoice_detail.customer_type==='person' || invoice_detail.customer_type==='company'" class="col-span-2">
                <label for="postal_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">کد پستی</label>
                <input type="text" id="postal_code" v-model="invoice_detail.address.postal_code" placeholder="کد پستی  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>
            ...
            <div v-show="invoice_detail.customer_type==='person' || invoice_detail.customer_type==='company'" class="col-span-2">
                ...
                <input type="text" id=" city" v-model="invoice_detail.address. city" placeholder=" شهر  خود را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
            </div>
            ...
            <div v-show="invoice_detail.customer_type==='person' || invoice_detail.customer_type==='company'" class="col-span-2 lg:col-span-6 md:col-span-4">
                ...
                <textarea id="address" v-model="invoice_detail.address.address" placeholder="آدرس  خود را وارد کنید"
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"></textarea>
            </div>
        </div>
