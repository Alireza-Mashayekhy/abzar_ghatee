<template>
    <Head>
        <title>جست و جوی ابزار و قطعات یدکی</title>
        <meta
            name="description"
            content="در میان ابزار و قطعات یدکی آن ها جست و جو کنید و ابزار و قطعات مورد نیاز خود را بیابید."
        />

        <meta property="og:locale" content="fa_IR" />
        <meta property="og:type" content="product" />
        <meta property="og:title" content="جست و جوی ابزار و قطعات یدکی " />
        <meta
...
export default {
    ...
    setup({ productsJson, brandsJson, categoriesJson }) {
        const page = usePage();
        ...
        brands = brands.map((brand) => ({
            ...brand,
            checked:
                brandsParams.includes(brand.slug) ||
                brandsParams.includes(brand.name),
        }));
        ...
        categories = categories.map((category) => ({
            ...
            checked:
                ...
                categoriesParams.includes(category.name),
        }));
