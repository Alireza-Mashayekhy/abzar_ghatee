            ...
            >
                <div class="container rounded-lg bg-white p-5 dark:bg-zinc-900">
                    <div class="mb-8">
                        ...
                        <p
                            class="mb-5 text-sm text-zinc-600 dark:text-zinc-300 xs:text-base"
                        >
                            سوال خود را پیدا نکردید ؟
                            <NuxtLink
                                href="/contact-us"
                                class="text-emerald-500 dark:text-emerald-400"
                                >با ما تماس بگیرید</NuxtLink
                            >
                        </p>
                    </div>
                    <div class="mb-16 grid grid-cols-12 gap-y-8 md:gap-x-8">
                        <div class="col-span-12 md:col-span-4">
                            <div class="sticky top-32">
                                <p
                                    class="mb-4 text-sm text-zinc-600 dark:text-zinc-300"
                                >
                                    سوال خود را جستجو کنید
                                </p>
                                <div
                                    class="flex items-center justify-between rounded-lg bg-gray-100 px-2 dark:bg-black"
                                >
                                    <div>
                                        <svg
                        ...
                        <div class="col-span-12 space-y-8 md:col-span-8">
                            <div
                                v-for="(qlist, idx) in questionLists"
                                :key="idx"
                            >
                                <div class="mb-4 flex items-center gap-x-2">
                                    ...
                                    ></span>
                                    <p
                                        class="text-lg font-medium text-zinc-700 dark:text-white"
                                    >
                                        {{ qlist.title }}
                                    </p>
                                </div>
                                <ul
                                    class="mr-2 space-y-4 divide-y divide-gray-100 dark:divide-white/5"
                                >
                                    <li
                                        v-for="(
                                            question, qidx
                                    ...
                                    >
                                        <div data-accordion="open">
                                            <div class="space-y-2">
                                                ...
                                                >
                                                    <div
                                                        class="mr-6 text-zinc-600 dark:text-zinc-300"
                                                    >
                                                        {{ question.answer }}
                                                    </div>
                                                </div>
                ...
                questions: [
                    {
                        ...
                        answer: 'شما می ‌توانید مشخصات کاربری خود را ویرایش کنید. برای این کار باید با وارد کردن پست الکترونیکی و کلمه عبور، وارد حساب کاربری خود بشوید، سپس با کلیک روی گزینه "پروفایل من" به صفحه ای منتقل می شوید که در بخش "اطلاعات کاربر" امکان "ویرایش اطلاعات" وجود دارد.',
                    },
                ],
            },
            {
                ...
                questions: [
                    {
                        question:
                            'آیا برای ثبت سفارش عضویت در سایت اجباری است؟',
                        answer: 'بله، با توجه به اینکه سفارشات نیاز به پیگیری و ارسال دارند لازم است قبل از ثبت سفارش داخل سایت عضو شوید البته قبل از عضویت در سایت می توانید محصولات مورد نظر را به سبد خرید اضافه کنید و عضویت در سایت را موقع نهایی کردن خرید انجام دهید.',
                    },
                    {
                        question:
                            ' آیا در تمام ساعات شبانه روز می‌توانم سفارش خود را ثبت کنم؟',
                        answer: 'شما در 24 ساعت شبانه روز و 7 روز هفته می‌ توانید سفارش خود را ثبت کنید.',
                    },
                    {
                        question:
                            'از وضعیت سفارشی که ثبت کرده ‌ام، چگونه می‌ توانم مطلع شوم؟',
                        answer: 'با مراجع به قسمت سفارشات در بخش کاربری خود می توانید وضعیت سفارش خود را ببینید.',
                    },
                    {
                        question: 'چطور به سفارشات قبلی خود دسترسی داشته باشم؟',
                        answer: 'شما با ورود به بخش کاربری می توانید کلیه ی سفارشات خود را با جزئیات مربوط به آن ها مشاهده کنید',
                    },
                ],
            },
            {
                ...
                questions: [
                    {
                        question:
                            'چگونه می توانم قیمت های همکاری را مشاهده کنم؟',
                        answer: 'برای مشاهده ی قیمت های همکاری و عمده لازم است که بعد از ثبت نام با بخش پشتیبانی تماس بگیرید تا سطح کاربری شما به همکار تغییر کند . بعد از آن در سایت به شما قیمت های همکاری را نمایش می دهد . البته برای مشاهده ی قیمت های همکاری باید در سایت ورود کرده باشید.',
                    },
                ],
            },
            {
                title: 'دریافت فاکتور رسمی',
                questions: [
                    {
                        question:
                            'چگونه می توانم فاکتور رسمی و ثبت شده داخل سایت مالیات دریافت کنم؟',
                        answer: 'برای دریافت فاکتور رسمی لازم است که تیک مربوط به آن را موقع ثبت سفارش بزنید و یا با پشتیبانی تماس بگیرید تا مالیات را روی فاکتور شما اعمال کنند. پس از پرداخت فاکتور، طی نهایت 3 روز کاری فاکتور شما داخل سایت مالیات ثبت و قابل استعلام خواهد بود.',
                    },
                ],
            },
        ];
