            ...
            >
                <div class="container rounded-lg bg-white p-5 dark:bg-zinc-900">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            افتخار ما در ابزارقطعه این است که فراتر از یک
                            فروشنده ی محصولات هستیم و می توانیم همراه و شریک شما
                            در دنیار ابزارالات و قطعات یدکی باشیم. شما در ابزار
                            قطعه علاوه بر خرید محصولات و قطعات یدکی آن ها می
                            توانید بصورت آنی هر محصول را استعلام قیمت و موجودی
                            بگیرید و به مشتری با خیال راحت قیمت تمام شده ی کار
                            را اعلام کنید.
                        </p>
                        <ul
