                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <button
                                        class="w-full"
                                        type="button"
                                        data-modal-target="fullname-modal"
                                        data-modal-toggle="fullname-modal"
                                    >
                                        <div
                                            class="relative rounded-lg border border-gray-100 p-4 hover:border-gray-200 dark:border-white/5 hover:dark:border-white/10"
                                        >
                                            <div class="flex justify-between">
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        class="mr-2 text-zinc-500 dark:text-zinc-400"
                                                    >
                                                        {{ user.name }}
                                                    </div>
                                                </div>
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <button
                                        class="w-full"
                                        type="button"
                                        data-modal-target="nationalCode-modal"
                                        data-modal-toggle="nationalCode-modal"
                                    >
                                        <div
                                            class="relative rounded-lg border border-gray-100 p-4 hover:border-gray-200 dark:border-white/5 hover:dark:border-white/10"
                                        >
                                            <div
                                                class="absolute inset-x-0 -bottom-2.5 mx-auto w-fit rounded-full bg-white px-3 text-sm font-medium text-red-500 dark:bg-zinc-900 dark:text-red-400"
                                            >
                                                تایید نشده
                                            </div>
                                            <div class="flex justify-between">
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <button
                                        class="w-full"
                                        type="button"
                                        data-modal-target="phoneNumber-modal"
                                        data-modal-toggle="phoneNumber-modal"
                                    >
                                        <div
                                            class="relative rounded-lg border border-gray-100 p-4 hover:border-gray-200 dark:border-white/5 hover:dark:border-white/10"
                                        >
                                            <div
                                                class="absolute inset-x-0 -bottom-2.5 mx-auto w-fit rounded-full bg-white px-3 text-sm font-medium text-emerald-500 dark:bg-zinc-900 dark:text-emerald-400"
                                            >
                                                تایید شده
                                            </div>
                                            <div class="flex justify-between">
                                        ...
                                        >
                                            <div class="flex justify-between">
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        class="mr-2 select-none text-zinc-500 dark:text-zinc-400"
                                                    >
                                                        ********
                                                    </div>
                                                </div>
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <button
                                        class="w-full"
                                        type="button"
                                        data-modal-target="birthDate-modal"
                                        data-modal-toggle="birthDate-modal"
                                    >
                                        <div
                                            class="relative rounded-lg border border-gray-100 p-4 hover:border-gray-200 dark:border-white/5 hover:dark:border-white/10"
                                        >
