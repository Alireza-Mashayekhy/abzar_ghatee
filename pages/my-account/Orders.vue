        ...
        <main class="flex-grow bg-gray-100 pb-14 pt-36 dark:bg-black xs:pt-36">
            <div class="container">
                <div class="grid grid-cols-12 gap-4">
                    <my-account-side-bar></my-account-side-bar>

                    <!-- content -->
                    <div class="col-span-12 lg:col-span-9">
                        <div
                            class="rounded-lg bg-white p-5 shadow-base dark:bg-zinc-900"
                        >
                            <!-- Title -->
                            <h1
                            ...
                            <div
                                v-if="
                                    Object.keys(
                                        ordersCategory.waiting_for_payment
                                    ).length > 0
                                "
                                class="mb-8"
                            >
                                ...
                                <div class="space-y-4">
                                    <!-- order item -->
                                    <div
                                        v-for="order in ordersCategory.waiting_for_payment"
                                        :key="order.id"
                                        class="rounded-lg border p-4 border-gray-100 shadow-base dark:border-white/5"
                                    >
                                        <NuxtLink
                                            :href="
                                                route(
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div
                                                                class="text-sm text-zinc-600 dark:text-zinc-300 md:text-base font-bold"
                                                            >
                                                                {{ order.id }}
                                                            </div>
                                                        </div>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                <span
                                                                    class="text-sm md:text-base mr-1"
                                                                    >تومان</span
                                                                >
                                                            </div>
                                                        </div>
                                    ...
                                    >
                                        <li role="presentation">
                                            <button
                                                ...
                                                aria-selected="false"
                                                class="flex items-center gap-x-2 whitespace-nowrap rounded-t-lg border-b-2 border-transparent px-2 pb-2 text-zinc-700 hover:text-zinc-600 dark:text-white dark:hover:text-zinc-300"
                                            ...
                                            >
                                                فعلی
                                                <span
                                                    class="flex h-7 w-7 items-center justify-center rounded-lg bg-emerald-500 text-base text-white dark:bg-emerald-600"
                                                >
                                                    {{
                                                        Object.keys(
                                ...
                                <div id="ordersFilterTab">
                                    ...
                                    >
                                        <div class="mb-8 space-y-4">
                                            ...
                                            <div
                                                v-for="order in ordersCategory.current"
                                                :key="order.id"
                                                class="rounded-lg border border-gray-100 shadow-base dark:border-white/5 p-4"
                                            >
                                                <NuxtLink
                                                    :href="
                                                        route(
                                                                ...
                                                                >
                                                                    <use
                                                                        v-if="
                                                                            order.is_paid
                                                                        "
                                                                        xlink:href="#outline-check"
                                                                    />
                                                                    <use
                                                                        v-else
                                                                        xlink:href="#order-canceled"
                                                                    />
                                                                </svg>
                                                                <p
                                                                    class="font-medium md:text-lg"
                                                                        ...
                                                                        <use
                                                                            v-else-if="
                                                                                ...
                                                                                order.status ===
                                                                                    'received'
                                                                            "
                                                                            xlink:href="#order-sent"
                                                                        />
                                                                        <use
                                                                            v-else
                                                                            xlink:href="#order-current"
                                                                        />
                                                                    </svg>
                                                                    <p
                                    ...
                                    >
                                        <div class="mb-8 space-y-4">
                                            <!-- order item -->
                                            <div
                                                v-for="order in ordersCategory.completed"
                                                :key="order.id"
                                            ...
                                            >
                                                ...
                                                >
                                                    <div class="p-4">
                                                        ...
                                                        <!-- conent -->
                                                        <div
                                                            class="mb-6 flex flex-col gap-6 xl:flex-row xl:justify-between xl:gap-16"
                                                        >
                                                            <div
                                                                class="flex flex-col gap-4 md:flex-row"
                                                            >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <span
                                                                        class="absolute inset-y-0 right-0 rounded-full bg-emerald-500 dark:bg-emerald-400"
                                                                        style="
                                                                            width: 100%;
                                                                        "
                                                                    ></span>
                                                                ...
                                                                <!-- order date -->
                                                                <div
                                                                    class="flex items-center justify-between text-sm text-emerald-500 dark:text-emerald-400 md:text-base"
                                                                >
                                                                    <span>
                                                                        {{
                                                                            dayjs(
                                    ...
                                    >
                                        <div class="mb-8 space-y-4">
                                            <!-- order item -->
                                            <div
                                                v-for="order in ordersCategory.canceled"
                                                :key="order.id"
                                                class="rounded-lg border border-gray-100 shadow-base dark:border-white/5"
                                            >
                                                <NuxtLink
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <div
                                                                        class="text-sm font-bold dark:text-zinc-300 md:text-base"
                                                                    >
                                                                        {{
                                                                            order.id
                                                                        }}
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <span
                                                                        class="absolute inset-y-0 right-0 rounded-full bg-red-500 dark:bg-red-400"
                                                                        style="
                                                                            width: 100%;
                                                                        "
                                                                    ></span>
                                                                ...
                                                                <!-- order date -->
                                                                <div
                                                                    class="flex items-center justify-between text-sm text-red-500 dark:text-red-400 md:text-base"
                                                                >
                                                                    <span>
                                                                        {{
                                                                            dayjs(
                                    ...
                                    >
                                        <div class="mb-8 space-y-4">
                                            <!-- order item -->
                                            <div
                                                v-for="order in ordersCategory.returned"
                                                :key="order.id"
                                                class="rounded-lg border border-gray-100 shadow-base dark:border-white/5"
                                            >
                                                <NuxtLink
                                                    ...
                                                    <div class="p-4">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <!-- order status -->
                                                                <div
                                                                    class="flex items-center gap-x-2 text-zinc-500 dark:text-zinc-400"
                                                                >
                                                                    <svg
                                                                        class="h-5 w-5 md:h-6 md:w-6"
                                                                    >
                                                                        <use
                                                                            xlink:href="#order-returned"
                                                                        />
                                                                    </svg>
                                                                    <p
                                                                        class="text-sm font-medium md:text-base"
                                                                ...
                                                                >
                                                                    <span
                                                                        class="absolute inset-y-0 right-0 rounded-full bg-zinc-500 dark:bg-zinc-400"
                                                                        style="
                                                                            width: 100%;
                                                                        "
                                                                    ></span>
                                                                ...
                                                                <!-- order date -->
                                                                <div
                                                                    class="flex items-center justify-between text-sm text-zinc-500 dark:text-zinc-400 md:text-base"
                                                                >
                                                                    <span>
                                                                        {{
                                                                            dayjs(
...
import { timeAgo } from '../../../../midone/enigma/utils/helper';
...
export default {
    ...
    setup({ ordersCategoryJson }) {
        dayjs.extend(jalali);
        const ordersCategory = JSON.parse(ordersCategoryJson);

        const statusMap = {
            preparation: 'آماده‌سازی',
            waiting_for_payment: 'در انتظار پرداخت',
            invoicing: 'صدور فاکتور',
            reviewing: 'منتظر تایید',
            returned: 'مرجوع شده',
            received: 'تحویل گرفته شده',
            completed: 'تکمیل شده',
            delivered: 'ارسال شده',
            canceled: 'لغو شده',
        };
