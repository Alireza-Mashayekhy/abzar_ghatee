                        ...
                        >
                            ...
                            >
                                ...
                                <NuxtLink
                                    ...
                                    class="btn-secondary w-full px-4 py-2 xs:w-fit"
                                >
                                    برگشت
                                    <svg class="h-5 w-5">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="relative max-w-lg rounded-lg bg-white p-6 shadow-lg dark:bg-zinc-900"
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        <div
                                                            class="divide-gray-100 dark:divide-white/5"
                                                        >
                                                            <!-- Order final price -->
                                                            <div
                                                                class="flex items-center justify-between gap-x-2 py-6"
                                                            >
                                                                <div
                                                        ...
                                                        >
                                                            ...
                                                            />
                                                            <fieldset
                                                                class="flex flex-wrap items-center justify-evenly gap-4 space-y-2 mb-6"
                                                            >
                                                                <legend
                                                                    class="sr-only"
                                                                >
                                                                ...
                                                                <div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <img
                                                                                src="./../../../../assets/images/sadad-logo.png"
                                                                                class="w-10 h-5 rounded-lg"
                                                                                alt=""
                                                                            />
                                                                            <p
                                                                ...
                                                                <div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <img
                                                                                src="./../../../../assets/images/zibal-logo.jpg"
                                                                                class="w-10 h-5 rounded-lg"
                                                                                alt=""
                                                                            />
                                                                            <p
                                                            ...
                                                            <button
                                                                type="submit"
                                                                class="btn-primary w-full px-4 py-2 text-sm xs:text-base"
                                                            >
                                                                پرداخت
                                                            </button>
                                                        </form>
                                            ...
                                            <button
                                                ...
                                                class="btn-primary w-full px-4 py-2 text-sm xs:w-32 xs:text-base"
                                            >
                                                پرداخت مجدد
                                            </button>
                                        </div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <!-- order date -->
                                            <div
                                                class="flex items-center justify-between text-sm text-yellow-500 dark:text-yellow-400 md:text-base"
                                            >
                                                <span>
                                                    {{
                                                        dayjs(
                            ...
                            <div class="mb-8">
                                ...
                                >
                                    <div
                                        class="flex flex-col gap-4 md:flex-row flex-wrap"
                                    >
                                        <div
                                        ...
                                        <!--                                                <span class="font-bold md:text-lg">122,800,000</span>-->
                            ...
                            <div class="mb-8">
                                <h2
                                    class="flex items-center mb-2 gap-x-4 text-lg text-zinc-600 dark:text-zinc-300"
                                >
                                    <span
                                ...
                                <div
                                    class="block mb-2 rounded-lg border border-gray-100 p-4 shadow-base hover:border-gray-200 dark:border-white/5 dark:hover:border-white/10"
                                >
                                    <div
                                        class="mb-4 flex flex-col gap-x-2 sm:mb-2"
                                    >
                                        <p
                                        ...
                                        <p
                                            class="text-sm text-zinc-600 dark:text-zinc-300 my-1"
                                        >
                                            {{
                                                order['shipping']['receiver'][
                                                    'address'
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                class="text-xs text-zinc-300 dark:text-zinc-400 md:text-base"
                                            >
                                                {{
                                                    delivery.delivery_tracking_code
                                                        ? delivery.delivery_tracking_code
                                                        : 'وارد نشده'
                                                }}
                                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                >
                                    ...
                                    >
                                        ( {{ order['sales_items_count'] }} کالا
                                        ) ( {{ order['sales_count'] }} تنوع )
                                    </span>
                                </h2>
                                <ul
                                    ...
                                    >
                                        <div class="py-4 sm:py-6">
                                            ...
                                            >
                                                <!-- Image -->
                                                <div
                                                    class="row-span-2 min-w-fit xs:mx-auto"
                                                >
                                                    <NuxtLink :href="sale.url">
                                                        <img
                                                            alt=""
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        v-if="
                                                            ...
                                                            0
                                                        "
                                                        class="flex flex-col items-start gap-x-2 text-red-500 dark:text-red-400 xs:flex-row xs:items-center"
                                                    >
                                                        <div
                                                    ...
                                                    <div
                                                        class="flex gap-4 xs:flex-col"
                                                    >
                                                        <div
                                                            class="flex items-center gap-x-2"
                                                        >
                                                            <div
                                                                class="text-xs text-zinc-600 dark:text-zinc-300 xs:text-base"
                                                            >
                                                                قیمت واحد
                                                            </div>
                                                            <div
