            ...
            >
                <div class="container rounded-lg bg-white p-5 dark:bg-zinc-900">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            خرید از ما بسیار آسان و ساده است، تقریباً مشابه
                            تجربه خرید آنلاین در سایت‌های دیگر است. برای خرید
                            محصولات مورد نظرتان، مراحل زیر را دنبال کنید:
                        </p>
                        ...
                        >
                            <li>
                                <strong>جستجو و مرور:</strong> وبسایت ما را
                                بررسی کنید تا محصولاتی که به دنبال آن هستید را
                                پیدا کنید. می‌توانید از نوار جستجو استفاده کنید
                                یا از طریق دسته‌بندی‌ها محصولات را کشف کنید.
                            </li>

                            <li>
                                <strong>افزودن به سبد خرید:</strong> هنگامی که
                                محصولات مورد نظر خود را پیدا کردید، به راحتی بر
                                روی دکمه "افزودن به سبد خرید" کنار هر مورد کلیک
                                کنید. محصولات انتخاب شده به سبد خرید شما اضافه
                                می‌شوند.
                            </li>

                            <li>
                                <strong>بررسی سبد خرید:</strong> محتویات سبد
                                خرید خود را بررسی کنید تا اطمینان حاصل کنید که
                                همه چیز صحیح است. می‌توانید تعداد محصولات را
                                تنظیم یا موارد را حذف کنید.
                            </li>

                            <li>
                                <strong>تسویه حساب:</strong> وقتی آماده نهایی
                                کردن خرید خود باشید، به مرحله تسویه حساب بروید.
                                اطلاعات حمل و نقل خود را پر کرده و روش پرداخت
                                مورد نظر خود را انتخاب کنید.
                            </li>

                            <li>
                                <strong>پرداخت:</strong> فرایند پرداخت را با
                                دنبال کردن دستورالعمل‌های ارائه شده برای روش
                                پرداخت انتخابی خود تکمیل کنید. پس از موفقیت آمیز
                                بودن پرداخت، سفارش شما پردازش خواهد شد.
                            </li>

                            <li>
                                <strong>تأیید سفارش:</strong> پس از انجام
                                پرداخت، شما یک تأیید سفارش با جزئیات خرید خود
                                دریافت خواهید کرد. سفارش شما سپس پردازش و برای
                                تحویل ارسال خواهد شد.
                            </li>
                        </ul>
                    </div>
                </div>
