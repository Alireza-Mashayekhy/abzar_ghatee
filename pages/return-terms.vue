            ...
            >
                <div class="container rounded-lg bg-white p-5 dark:bg-zinc-900">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            ارزشمند ترین سرمایه ی ابزارقطعه شما مشتریان آن هستید
                            که به منظور راحتی شما در اعتماد به ابزار قطعه و
                            کیفیت کالا های دریافتی از ما برای کالاهای این
                            فروشگاه ضمانت بازگشت کالا در نظر گرفته شده است. شما
                            تا ۲۴ ساعت پس از تحویل کالا می توانید درصورت وجود
                            اشکال در آن ، آن را به کارشناسان ما اعلام کنید و سپس
                            اگر شامل شرایط مرجوعی می شد آنرا مرجوعی کنید. شرایط
                            مرجوعی موارد زیر است:
                        </p>
                        <ul
                            class="mb-5 list-inside list-decimal space-y-3 text-zinc-600 dark:text-zinc-300"
                        >
                            <li>
                                هزینه ی ارسال مرسوله به عهده ی ابزارقطعه می باشد
                                و همراه مبلغ سفارش به مشتری عودت داده می شود.
                            </li>
                            <li>از دستگاه دستگاه استفاده نشده باشد.</li>
                            <li>
                                سفارش اشتباه ( انتخاب اشتباه محصول ) شامل مرجوعی
                                نمی شود و مرجوعی تنها شامل محصولات با مشکلات فنی
                                کارخانه ای یا ارسال اشتباه توسط ما می شود. البته
                                در مواردی سفارش اشتباه نیز اگر از محصول استفاده
                                نشده باشد شامل مرجوعی می شود.
                            </li>
                            <li>
                                تمامی محصولات ارسالی بیمه می شوند و خسارت وارده
                                بر محصولات در حمل و نقل از بیمه گرفته می شود. (
                                برای این منظور باید قبل از امضا کردن برگه ی
                                دریافت محصول از سالم بودن آن و آسیب ندیدن آن در
                                حمل و نقل اطمینان حاصل کنید و در صورت آسیب دیده
                                بودن محصول آن را تحویل نگیرید و با ما تماس
                                بگیرید. )
                            </li>
                            <li>
                                در صورت مرجوعی اشتباه ، محموله دوباره برای مشتری
                                ارسال می شود لازم به ذکر است که مبلغ ارسال برای
                                این مورد به عهده ی مشتری می باشد. و در صورت عدم
                                واریز مبلغ ارسال توسط مشتری ، آن محموله تا یک
                                ماه نزد ابزار قطعه باقی می ماند و پس از آن
                                مالکیت آن برای ابزار قطعه می شود و مبلغی به
                                مشتری عودت داده نمی شود.
                            </li>
                        </ul>
                    </div>
                </div>
