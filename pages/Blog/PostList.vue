<template>
    <Head>
        <title>دانستنی های ابزار - وبلاگ ابزار قطعه</title>

        <meta
            name="description"
            content="با بالا بردن اطلاعات ابزاری خود، هم کیفیت کار خود را افزایش دهید هم در هزینه های خود صرفه جویی کنید."
        />
        <NuxtLink rel="canonical" href="https://abzarghete.com/blog/" />
        <meta property="og:locale" content="fa_IR" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="وبلاگ - ابزار قطعه" />
        <meta
...
export default {
    ...
    setup({ postsJson, categoriesJson }) {
        dayjs.extend(jalali);
