<template>
    <div>
        ...
        <div class="bg-gray-50">
            ...
            >
                <div
                    class="mt-10 flex flex-col items-center justify-center gap-y-6"
                >
                    <h1
                        class="text-9xl font-bold text-zinc-600 dark:text-zinc-300"
                    >
                        {{ status }}
                    </h1>
                    <h2
                        class="text-lg text-zinc-600 dark:text-zinc-300 lg:text-xl"
                    >
                        {{ statusMessage[status] || statusMessage.default }}
                    </h2>

                    <NuxtLink class="btn-primary px-6 py-3" href=""
                        >بازگشت به صفحه اصلی</NuxtLink
                    >
                </div>
            </main>
        </div>
...
export default {
    ...
    setup() {
        const statusMessage = {
            404: 'متاسفانه صفحه‌ای که جستجو کرده‌اید یافت نشد.',
            401: 'برای دسترسی به این بخش، لطفا وارد سیستم شوید.',
            403: 'متاسفانه اجازه دسترسی به این بخش را ندارید.',
            500: 'مشکلی در سرور پیش آمده است. لطفا بعدا دوباره امتحان کنید.',
            503: 'متاسفانه سرویس در حال حاضر در دسترس نیست. لطفا کمی بعد دوباره امتحان کنید.',
            419: 'نشست کاربری شما منقضی شده است. لطفا دوباره وارد سیستم شوید.',
            default: 'متاسفانه مشکلی پیش آمده است. لطفا دوباره امتحان کنید.',
        };
