<template>
    <div class="sr-only">
        <svg>
            <symbol id="svg-spinners-90-ring" viewBox="0 0 24 24">
                <path
            ...
            <symbol id="svg-spinners-3-dots-scale" viewBox="0 0 24 24">
            ...
            <symbol id="svg-spinners-3-dots-fade" viewBox="0 0 24 24">
                <circle cx="4" cy="12" fill="currentColor" r="3">
                    <animate
                ...
                <circle cx="12" cy="12" fill="currentColor" opacity=".4" r="3">
                    <animate
                        attributeName="opacity"
                ...
                <circle cx="20" cy="12" fill="currentColor" opacity=".3" r="3">
                    <animate
            ...
            <symbol id="svg-spinners-6-dots-rotate" viewBox="0 0 24 24">
                <g>
                    <circle
                        cx="12"
                        cy="2.5"
            ...
            <symbol id="svg-spinners-ring-resize" viewBox="0 0 24 24">
            ...
            <symbol id="svg-spinners-180-ring" viewBox="0 0 24 24">
                <path
            ...
            <symbol id="why-us" viewBox="0 0 256 256">
                <path
            ...
            <!-- ph-devices-light -->
            <symbol id="how-to-buy" viewBox="0 0 256 256">
                <path
            ...
            <!-- ph-fire-light -->
            <symbol id="special-sale" viewBox="0 0 256 256">
                <path
        ...
        <div class="fixed left-0 right-0 top-0 z-30 bg-white dark:bg-zinc-900">
            ...
            <div>
                <div class="hidden md:block">
                    ...
                    >
                        <!-- logo -->
                        <div>
                            <NuxtLink :href="route('main')">
                                <img
                                    alt=""
                                    class="w-44 text-red-700"
                                    src="../../../../../assets/images/abzarghete_logo.svg"
                                />
                            </NuxtLink>
                        </div>
                        <!-- Search -->
                                ...
                                <div class="max-h-[450px] overflow-y-auto py-5">
                                    ...
                                    <div class="mb-8 px-5">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <svg class="h-10 w-10">
                                                        <use
                                                            xlink:href="#recent-off"
                                                        />
                                                    </svg>
                                                    <p class="md:text-xl">
                                                        جست جوی شما نتیجه ای در
                                                        بر نداشت
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        >
                                            <!-- Product Card -->
                                            <swiper-slide
                                                v-for="p in search_data.products"
                                                :key="p.id"
                                                class="w-50"
                                            >
                                                <NuxtLink
                                    ...
                                    <div class="space-y-6">
                                        <div class="px-5">
                                            ...
                                            >
                                                <swiper-slide
                                                    v-for="cat in search_data.categories"
                                                    :key="cat.id"
                                                    class="w-50"
                                                >
                                                    <NuxtLink
                        ...
                        <div class="flex gap-x-4">
                                    ...
                                    <ul class="space-y-1 p-2">
                                        <li>
                                            <NuxtLink
                                                ...
                                                class="flex items-center justify-between gap-x-2 rounded-lg p-4 text-zinc-700 hover:text-emerald-500 dark:text-white dark:hover:text-emerald-400"
                                            >
                                                <span
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            useCartStore().total.toLocaleString(
                                                'fa'
                                            )
                                        }}
                                    </span>
                                ...
                                >
                                    <div v-if="useCartStore().isEmpty">
                                        ...
                                        >
                                            ...
                                            >
                                                <svg
                                                    class="w-20 h-20 text-zinc-600 dark:text-zinc-300"
                                                >
                                                    <use
                                                        xlink:href="#order-off"
                                                    />
                                                </svg>
                                                <p
                                                    class="text-zinc-600 dark:text-zinc-300 text-lg"
                                                >
                                    ...
                                    <div v-else>
                                        <!-- Head -->
                                        <div
                                            class="flex items-center justify-between p-5 pb-2"
                                        >
                                            <div
                                                class="text-sm text-zinc-600 dark:text-zinc-300"
                                            >
                                                {{
                                                    useCartStore().totalVariations.toLocaleString(
                                                        'fa'
                                                    )
                                                }}
                                                مورد
                            ...
                            <div
                                ...
                                class="cursor-pointer text-zinc-700 dark:text-white"
                            >
                                <svg id="themeIconDesktop" class="h-6 w-6">
                                    <use xlink:href="#moon" />
                                </svg>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            <ul id="desktopMegamenuWrapper" class="group z-10">
                                <div
                                ...
                                <div
                                    class="absolute top-full w-full max-w-[1000px]"
                                >
                                    <div
                                        id="desktopMegamenu"
                                            ...
                                            >
                                                ...
                                                >
                                                    <li
                                                        v-for="(
                                                            item, index
                                                        ) in desktop_mega_menu"
                                                        :key="index"
                                                    >
                                                        <NuxtLink
                                                            class="flex py-4 pr-4 text-zinc-700 dark:text-white"
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <div class="mb-4">
                                                            <NuxtLink
                                                                class="flex items-center gap-x-1 py-2 text-sm text-emerald-500 dark:text-emerald-400"
                                                                :href="item.url"
                                                            >
                                                                <div>
                                                                    مشاهده همه
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <NuxtLink
                                                                    class="flex items-center gap-x-2 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400"
                                                                    :href="
                                                                        item2.href
                                                                    "
                                                                >
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    >
                                                                        <NuxtLink
                                                                            class="block py-2 text-sm text-zinc-600 hover:text-emerald-500 dark:text-zinc-300 hover:dark:text-emerald-400"
                                                                            :href="
                                                                                item3.href
                                                                            "
                                                                        >
                            ...
                            <ul
                                data-color-dark="#f87171"
                                data-color-light="#ef4444"
                            >
                                <NuxtLink :href="route('shop')" class="group">
                                    <div
                                        class="p-2 pt-0 text-zinc-700 dark:text-white"
                                    >
                                        فروشگاه
                                    </div>
                                </NuxtLink>
                            ...
                            >
                                <NuxtLink
                                    :href="route('amazing-suggestions')"
                                    class="group"
                                >
                                    <div
                                        class="p-2 pt-0 text-zinc-700 dark:text-white"
                            ...
                            <ul>
                                <NuxtLink :href="route('why-us')" class="group">
                                    <div
                                        class="p-2 pt-0 text-zinc-700 dark:text-white"
                                    >
                                        چرا ابزار قطعه
            ...
            <div>
                <div class="md:hidden">
                    ...
                    >
                        <div class="container">
                            <div id="mobileHeaderSearchBase" class="relative">
                                <form
                                ...
                                >
                                    <div
                                        class="max-h-[450px] overflow-y-auto py-5"
                                    >
                                        <!-- Result -->
                                        <div class="mb-8 px-5">
                                            <div
    ...
    <div>
        ...
        >
            ...
            <div class="mb-4">
                ...
                >
                    <div>
                        <svg id="themeIconMobile" class="h-6 w-6">
                            <use xlink:href="#moon" />
                        </svg>
                    </div>
        ...
        >
            ...
            >
                ...
                <h5 class="text-lg text-zinc-700 dark:text-white">
                    حساب کاربری
                </h5>
            </div>
            <div class="overflow-y-auto">
                <ul class="space-y-4">
                    <li>
                        ...
                        >
                            <span class="flex items-center gap-x-4">
                                <span class="min-w-fit">
                                    <svg class="h-10 w-10 rounded-full">
                                        <use xlink:href="#user" />
                                    </svg>
                                </span>
                                <span class="line-clamp-1"
                    ...
                    <li>
                        <NuxtLink
                            :href="route('my-account.notifications')"
                            class="flex items-center justify-between rounded-lg px-4 py-3 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400"
                        >
                            <span class="flex items-center gap-x-2">
                                <svg class="h-6 w-6">
            ...
            >
                ...
                <h5 class="text-lg text-zinc-600 dark:text-zinc-300">
                    ...
                    <span class="text-sm"
                        >(
                        {{
                            useCartStore().totalVariations.toLocaleString('fa')
                        }}
                        )</span
                    >
                </h5>
                        ...
                        <div class="flex gap-x-2 py-5">
                            ...
                            <div class="relative min-w-fit">
                                ...
                                <button
                                    ...
                                    type="button"
                                    @click="
                                        useCartStore().removeFromCart(item.id)
                                    "
                                >
                                    <svg
                            ...
                            <div class="w-full space-y-1.5">
                                ...
                                <NuxtLink
                                    :href="item.url"
                                    class="line-clamp-2 h-10 text-sm text-zinc-700 dark:text-white"
                                >
                                    {{ item.name }}
                                </NuxtLink>
                                <!-- Product Attribute -->
...
const desktop_mega_menu = [
    {
        href: route('category', 'power-tools'),
        name: 'ابزار برقی',
        data: [
            {
                href: route('category', 'drills'),
                name: 'دریل ها',
                data: [
                    {
                        href: route('category', 'hammer-drills'),
                        name: 'دریل چکشی',
                    },
                    {
                        href: route('category', 'impact-drills'),
                        name: 'دریل گیربکسی',
                    },
                    {
                        href: route('category', 'angle-drills'),
                        name: 'دریل سرکج',
                    },
                    {
                        href: route('category', 'mixer-drills'),
                        name: 'دریل همزن',
                    },
                    {
                        href: route('category', 'magnetic-drills'),
                        name: 'دریل مگنتی',
                    },
                    {
                        href: route('category', 'drill-presses'),
                        name: 'دریل ستونی',
                    },
                ],
            },
            {
                href: route('category', 'grinder'),
                name: 'فرز ها',
                data: [
                    {
                        href: route('category', 'metal-grinder'),
                        name: 'فرز آهنگری',
                    },
                    {
                        href: route('category', 'stone-grinder'),
                        name: 'فرز سنگبری',
                    },
                    {
                        href: route('category', 'mini-grinder'),
                        name: 'مینی فرز',
                    },
                    {
                        href: route('category', 'middle-angel-grinder'),
                        name: 'سنگ فرز متوسط',
                    },
                    {
                        href: route('category', 'polisher'),
                        name: 'پولیش',
                    },
                    {
                        href: route('category', 'long_mini_grinder'),
                        name: 'مینی فرز دسته بلند',
                    },
                    {
                        href: route('category', 'direct_grinder'),
                        name: 'سنگ فرز مستقیم',
                    },
                    {
                        href: route('category', 'die-grinder'),
                        name: 'فرز انگشتی',
                    },
                    {
                        href: route('category', 'micro-grinder'),
                        name: 'فرز مینیاتوری',
                    },
                    {
                        href: route('category', 'router-angle-grinder'),
                        name: 'اورفرز نجاری',
                    },
                ],
            },
            {
                href: route('category', 'saw'),
                name: 'اره ها',
                data: [
                    {
                        href: route('category', 'reciprocating-saw'),
                        name: 'اره افقی بر',
                    },
                    {
                        href: route('category', 'cut-off-saw'),
                        name: 'اره پرفیل بر',
                    },
                    {
                        href: route('category', 'jig-saw'),
                        name: 'اره عمودبر',
                    },
                    {
                        href: route('category', 'sliding-metter'),
                        name: 'اره فارسی بر',
                    },
                    {
                        href: route('category', 'cycle-saw'),
                        name: 'اره گردبر',
                    },
                    {
                        href: route('category', 'table-saw'),
                        name: 'اره میزی',
                    },
                    {
                        href: route('category', 'chain-saw'),
                        name: 'اره زنجیری',
                    },
                ],
            },
            {
                href: route('category', 'other-powertools'),
                name: 'سایر ابزار',
                data: [
                    {
                        href: route('category', 'demolition-hammer'),
                        name: 'چکش تخریب',
                    },
                    {
                        href: route('category', 'rottary-hammer'),
                        name: 'بتن کن',
                    },
                    {
                        href: route('category', 'multi-tools'),
                        name: 'همه کاره',
                    },
                    {
                        href: route('category', 'stapler'),
                        name: 'منگنه کوب',
                    },
                    {
                        href: route('category', 'nailer'),
                        name: 'میخکوب',
                    },
                    {
                        href: route('category', 'tile-cutter'),
                        name: 'کاشی بر',
                    },
                    {
                        href: route('category', 'electric-planer'),
                        name: 'رنده برقی',
                    },
                ],
            },
    ...
    },
    {
        ...
        data: [
            {
                href: route('category', 'cordless-drills'),
                name: 'دریل شارژی',
            },
            {
                href: route('category', 'cordless-screw-driver'),
                name: 'پیچ گوشتی شارژی',
            },
            {
                href: route('category', 'cordless-reciprocating-saw'),
                name: 'اره افقی بر شارژی',
            },
            {
                href: route('category', 'cordless-mini-angle-grinder'),
                name: 'مینی فرز شارژی',
            },
            {
                href: route('category', 'cordless-electric-wrench'),
                name: 'آچاربکس شارژی',
            },
            {
                href: route('category', 'cordless-hammer-drills'),
                name: 'بتن کن شارژي',
            },
            {
                href: route('category', 'cordless-multi-tools'),
                name: 'همه کاره شارژی',
            },
        ],
    },
    {
        href: route('category', 'spare_parts'),
        name: 'قطعات ابزار',
        data: [
            {
                href: route('category', 'armature'),
                name: 'آرمیچر',
            },
            {
                href: route('category', 'collector'),
                name: 'کلکتور آرمیچر',
            },
            {
                href: route('category', 'stator'),
                name: 'بالشتک ( استاتور )',
            },
            {
                href: route('category', 'carbon-brush'),
                name: 'ذغال ابزار',
            },
            {
                href: route('category', 'carbon-brush-seat'),
                name: 'جا ذغالی',
            },
            {
                href: route('category', 'drill-engine'),
                name: 'موتور دریل شارژی',
            },
            {
                href: route('category', 'gear'),
                name: 'دنده',
            },
            {
                href: route('category', 'کلید'),
                name: 'switch',
            },
        ],
    },
    {
        href: route('category', 'power-tools-accessories'),
        name: 'لوازم جانبی ابزار',
        data: [
            {
                href: route('category', 'charger'),
                name: 'شارژر',
            },
            {
                href: route('category', 'battery'),
                name: 'باتری',
            },
            {
                href: route('category', 'cable'),
                name: 'کابل ( سیم )',
            },
            {
                href: route('category', 'grease'),
                name: 'گیریس',
            },
            {
                href: route('category', 'chunk-wrench'),
                name: 'آچار سه نظام',
            },
        ],
    },
...
const loginHref = computed(
    () => route('login') + '?redirect_to=' + encodeURIComponent(currentUrl)
);
const registerHref = computed(
    () => route('register') + '?redirect_to=' + encodeURIComponent(currentUrl)
);
...
function onSearchSubmit() {
    router.visit(route('search') + '?q=' + search_query.value);
}
onBeforeMount(() => {
...
onMounted(() => {
    ...
    const desktopHeaderBottom = document.getElementById(
    ...
    if (desktopSearchComponent && mobileSearchComponent) {
        const {
            base: desktopBase,
            hideSearchResults: hideDesktopSearchResults,
